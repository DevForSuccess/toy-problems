...
Tree.prototype.BFSelect = function (filter) {
    ...
    let _bfSelect = function (tree, depth) {
        if (depth === 0 && filter(tree.value, depth)) {
        ...
        tree.children.forEach(child => _bfSelect(child, depth + 1));
    }
    _bfSelect(this, 0);
    return result;
};
...
let result = root1.BFSelect(function (value, depth) {
    return value % 2;
}); // [1, 3, 5, 7]
console.log(result);
